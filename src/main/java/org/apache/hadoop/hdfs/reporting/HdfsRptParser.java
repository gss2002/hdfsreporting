...
* </ul>
*/
public class HdfsRptParser extends GnuParser {

 public static final Log LOG = LogFactory.getLog(HdfsRptParser.class.getName());

 // We need a handle to Option.addValueForProcessing(String).
 // Since Hadoop will load this in a different classloader than
 // this HdfsReporting class, we cannot see their package-specific methods.
